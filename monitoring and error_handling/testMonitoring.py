...
import requests
monitoringURL = "http://127.0.0.1:5002/monitoring"
...
def create_log():
    ...
    userid = "testing123"
    logContent = "This is just a random log account"
       
    errorJson = ({        "log_from": logFrom,
...
if __name__ == "__main__":
    print("This is " + os.path.basename(__file__) + ": creating an log...")
    log = create_log()
    send_log(log)
#    print(get_all())
